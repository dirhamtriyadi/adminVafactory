...
const InvoicePenjualan = (data = "") => {
  ...
  doc.text("Nama Pembeli : " + data.name, 14, 25);
  doc.text(
  ...
  data.items.forEach((item) => {
    let row = [
      ...
      {
        content: item.price.toLocaleString("kr-KO"),
        styles: {
          halign: "right",
        },
      },
      {
        content: item.subtotal.toLocaleString("kr-KO"),
        styles: {
          halign: "right",
        },
      },
  ...
  let footer = [
    ...
    {
      content: `${data.items.reduce((a, b) => a + parseInt(b.qty),0).toLocaleString("kr-KO")}`,
      styles: {
        fillColor: "#E8E5E5",
        textColor: "#000",
        halign: "right",
    ...
    {
      content: `${data.items.reduce((a, b) => a + b.price, 0).toLocaleString("kr-KO")}`,
      styles: {
        fillColor: "#E8E5E5",
        textColor: "#000",
        halign: "right",
    ...
    {
      content: `${data.items.reduce((a, b) => a + b.subtotal,0).toLocaleString("kr-KO")}`,
      styles: {
        fillColor: "#E8E5E5",
        textColor: "#000",
        halign: "right",
