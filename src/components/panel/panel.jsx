          ...
          {this.props.submenu && (
            <>
              ...
              <li className="breadcrumb-item">
                <Link to="#">{this.props.menu}</Link>
              </li>
            </>
          )}
        </ol>
        <h1 className="page-header">{this.props.menu} </h1>
        <Panel>
          <PanelHeader>{this.props.menu}</PanelHeader>
...
export { Panel, PanelContent, PanelHeader, PanelBody, PanelFooter };
